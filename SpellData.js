...
const SPELL_DATA = {
    ...
    powerChords: {
        ...
        type: 'ultimate',
        spellClass: 'aoe',
        sprite: 'Sprites/Effect_PowerChords_1_517x353-ultimate-92.png',
        frameCount: 92,
        width: 400,
        height: 400,
        damage: 200,
    ...
    pumpkinUltimate: {
        ...
        type: 'ultimate',
        spellClass: 'aoe',
        sprite: 'Sprites/pumpkin-sprite-sheet-ultimate-6.png',
        frameCount: 6,
        width: 150,
        height: 150,
        damage: 150,
    ...
    darkDash: {
        ...
        type: 'active',
        spellClass: 'melee',
        sprite: 'Sprites/dark-effect-dash-12.png',
        frameCount: 12,
        width: 80,
        height: 80,
        damage: 30,
    ...
    magicSpell: {
        ...
        sprite: 'Sprites/1_magicspell_spritesheet-73.png',
        frameCount: 73,
        width: 48,
        height: 48,
        damage: 25,
    ...
    magic8: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/2_magic8_spritesheet-61.png',
        frameCount: 61,
        width: 50,
        height: 50,
        damage: 30,
    ...
    bluefire: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/3_bluefire_spritesheet-61.png',
        frameCount: 61,
        width: 52,
        height: 52,
        damage: 35,
    ...
    flameLash: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/6_flamelash_spritesheet-39.png',
        frameCount: 39,
        width: 60,
        height: 60,
        damage: 28,
    ...
    brightFire: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/9_brightfire_spritesheet-61.png',
        frameCount: 61,
        width: 48,
        height: 48,
        damage: 32,
    ...
    fireSpell: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/11_fire_spritesheet-61.png',
        frameCount: 61,
        width: 46,
        height: 46,
        damage: 26,
    ...
    nebula: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/12_nebula_spritesheet-61.png',
        frameCount: 61,
        width: 54,
        height: 54,
        damage: 38,
    ...
    phantom: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/14_phantom_spritesheet-61.png',
        frameCount: 61,
        width: 50,
        height: 50,
        damage: 30,
    ...
    sunburn: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/16_sunburn_spritesheet-61.png',
        frameCount: 61,
        width: 56,
        height: 56,
        damage: 42,
    ...
    felSpell: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/17_felspell_spritesheet-91.png',
        frameCount: 91,
        width: 58,
        height: 58,
        damage: 40,
    ...
    midnight: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/18_midnight_spritesheet-61.png',
        frameCount: 61,
        width: 52,
        height: 52,
        damage: 34,
    ...
    freezing: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/19_freezing_spritesheet-86.png',
        frameCount: 86,
        width: 50,
        height: 50,
        damage: 28,
    ...
    magicBubbles: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/20_magicbubbles_spritesheet-61.png',
        frameCount: 61,
        width: 44,
        height: 44,
        damage: 22,
    ...
    chainLightning: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/chain-light-4.png',
        frameCount: 4,
        width: 40,
        height: 40,
        damage: 30,
    ...
    iceSpike: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/ice-spike-11.png',
        frameCount: 11,
        width: 42,
        height: 42,
        damage: 35,
    ...
    randomLightning: {
        ...
        type: 'passive',
        spellClass: 'projectile',
        sprite: 'Sprites/random-lightning-9.png',
        frameCount: 9,
        width: 45,
        height: 45,
        damage: 38,
    ...
    fireSpin: {
        ...
        type: 'passive',
        spellClass: 'orbital',
        sprite: 'Sprites/7_firespin_spritesheet-61.png',
        frameCount: 61,
        width: 50,
        height: 50,
        damage: 25,
    ...
    fireOrbital: {
        ...
        type: 'passive',
        spellClass: 'orbital',
        sprite: 'Sprites/fire-orbital-9.png',
        frameCount: 9,
        width: 48,
        height: 48,
        damage: 22,
    ...
    protectionCircle: {
        ...
        type: 'passive',
        spellClass: 'aoe',
        sprite: 'Sprites/8_protectioncircle_spritesheet-61.png',
        frameCount: 61,
        width: 80,
        height: 80,
        damage: 15,
    ...
    vortex: {
        ...
        type: 'passive',
        spellClass: 'aoe',
        sprite: 'Sprites/13_vortex_spritesheet-61.png',
        frameCount: 61,
        width: 100,
        height: 100,
        damage: 28,
    ...
    whirlpoolFire: {
        ...
        type: 'passive',
        spellClass: 'aoe',
        sprite: 'Sprites/whirlpool-fire-12.png',
        frameCount: 12,
        width: 90,
        height: 90,
        damage: 32,
    ...
    waveEffect: {
        ...
        type: 'passive',
        spellClass: 'aoe',
        sprite: 'Sprites/wave-effect-11.png',
        frameCount: 11,
        width: 120,
        height: 120,
        damage: 40,
    ...
    blackHole: {
        ...
        type: 'passive',
        spellClass: 'aoe',
        sprite: 'Sprites/black-hole-remain-5sec-5.png',
        frameCount: 5,
        width: 110,
        height: 110,
        damage: 35,
    ...
    pumpkinExplosion: {
        ...
        type: 'passive',
        spellClass: 'aoe',
        sprite: 'Sprites/pumpkin-explosion-27.png',
        frameCount: 27,
        width: 100,
        height: 100,
        damage: 45,
    ...
    soulExplosion: {
        ...
        type: 'passive',
        spellClass: 'aoe',
        sprite: 'Sprites/soul-explosion-9.png',
        frameCount: 9,
        width: 95,
        height: 95,
        damage: 42,
    ...
    electricShield: {
        ...
        type: 'passive',
        spellClass: 'shield',
        sprite: 'Sprites/Effect_ElectricShield_1_265x265-63.png',
        frameCount: 63,
        width: 100,
        height: 100,
        damage: 20,
    ...
    lightningShield: {
        ...
        type: 'passive',
        spellClass: 'shield',
        sprite: 'Sprites/lightning-shield-4.png',
        frameCount: 4,
        width: 90,
        height: 90,
        damage: 18,
    ...
    pumpkinShield: {
        ...
        type: 'passive',
        spellClass: 'shield',
        sprite: 'Sprites/pumpkin-shield-5.png',
        upgradeSprite: 'Sprites/pumpkin-shield-upgrade-5.png',
        frameCount: 5,
        width: 85,
        height: 85,
        damage: 15,
    ...
    hammerSmash: {
        ...
        type: 'passive',
        spellClass: 'melee',
        sprite: 'Sprites/hammer-smash-14.png',
        frameCount: 14,
        width: 100,
        height: 100,
        damage: 50,
    ...
    lightningSmash: {
        ...
        type: 'passive',
        spellClass: 'melee',
        sprite: 'Sprites/lightning-smash-5.png',
        frameCount: 5,
        width: 95,
        height: 95,
        damage: 45,
    ...
    pumpkinSmash: {
        ...
        type: 'passive',
        spellClass: 'melee',
        sprite: 'Sprites/pumpkin-smash-8.png',
        upgradeSprite: 'Sprites/pumpkin-smash-upgrade-9.png',
        frameCount: 8,
        width: 90,
        height: 90,
        damage: 40,
    ...
    smashHit: {
        ...
        type: 'passive',
        spellClass: 'melee',
        sprite: 'Sprites/smash-hit-8.png',
        frameCount: 8,
        width: 85,
        height: 85,
        damage: 35,
    ...
    weaponHit: {
        ...
        type: 'passive',
        spellClass: 'melee',
        sprite: 'Sprites/10_weaponhit_spritesheet-29.png',
        frameCount: 29,
        width: 80,
        height: 80,
        damage: 30,
    ...
    pumpkinMastery: {
        ...
        type: 'passive',
        spellClass: 'melee',
        sprite: 'Sprites/pumpkin-smash-upgrade-9.png',
        frameCount: 9,
        width: 120,
        height: 120,
        damage: 100,
